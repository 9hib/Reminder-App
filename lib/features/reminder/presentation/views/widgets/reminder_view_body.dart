...
import 'package:reminder_app/features/reminder/presentation/views/widgets/reminder_view_loaded_body.dart';
    ...
    return BlocBuilder<ReminderCubit, ReminderState>(
      builder: (BuildContext context, ReminderState state) {
        if (state is ReminderLoading) {
          ...
          return ReminderViewLoadedBody(reminders: state.reminders);
